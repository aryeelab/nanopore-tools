workflow preprocess_flowcell {
    ...
    scatter (fastq_gz in basecall_and_demultiplex.fastq_gzs) {
        ...
        call call_methylation {input:   fast5_zip = fast5_zip,
         ...
         call get_methylation_by_read {input: base_methylation_calls = call_methylation.methylation_calls, version = version, threshold_ll = 2.5, cpg_islands = cpg_islands, chrs = chrs, compartments = compartments, monitoring_script = monitoring_script}
    }
